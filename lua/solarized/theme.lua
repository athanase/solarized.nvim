...
theme.loadEditor = function()
    local editor = {
        ...
        FloatBorder = { fg = solarized.fg },                       -- normal text and background color
...
theme.loadTreeSitter = function()
    local treesitter = {
        ...
        ["@constant.builtin"] = { fg = solarized.orange },
...
theme.loadPlugins = function()
    local plugins = {
        ...
        TelescopeResultsClass        = { fg = solarized.magenta },
        TelescopeResultsStruct       = { fg = solarized.magenta },
        TelescopeResultsField        = { fg = solarized.cyan },
        TelescopeResultsMethod       = { fg = solarized.blue },
        TelescopeResultsConstant     = { fg = solarized.green },
        TelescopeResultsVariable     = { fg = solarized.blue },
        TelescopeResultsNamespace    = { fg = solarized.green },
        -- NvimTree
        ...
        -- Bqf
        BqfPreviewBorder             = { fg = solarized.green },
        BqfPreviewRange              = { fg = solarized.green },
        BqfPreviewBufLabel           = { fg = solarized.green },
        -- qf
        qfCppCompilerErrorsGenerated = { fg = solarized.base01 },
        qfCppCompilerBuildStopped    = { fg = solarized.base01 },
        qfCppCompilerCommandCCACHE   = { fg = solarized.base01 },
        qfCppCompilerCommandCLANG    = { fg = solarized.base01 },
        qfCppBuilding                = { fg = solarized.green },
        qfCppLinking                 = { fg = solarized.magenta },
        qfCppAutomaticMOC            = { fg = solarized.green },
        qfCppCreatingSymlink         = { fg = solarized.green },
        qfCppFailed                  = { fg = solarized.red },
        qfFileName                   = { fg = solarized.blue },
        qfLineNr                     = { fg = solarized.base01 },
        qfSeparatorLeft              = { fg = solarized.base01 },
        qfSeparatorRight             = { fg = solarized.base01 },
        qfError                      = { fg = solarized.red },
        qfWarning                    = { fg = solarized.yellow },
        qfExitSuccess                = { fg = solarized.green },
        qfExitFailure                = { fg = solarized.red },
        -- Cmp
        CmpItemKindFunction          = { fg = solarized.blue },
        CmpItemKindMethod            = { fg = solarized.blue },
        CmpItemKindField             = { fg = solarized.cyan },
        CmpItemKindClass             = { fg = solarized.magenta },
        CmpItemKindInterface         = { fg = solarized.magenta },
        CmpItemKindVariable          = { fg = solarized.cyan },
        CmpItemKindKeyword           = { fg = solarized.orange },
        CmpItemKindConstant          = { fg = solarized.orange },
        CmpItemKindReference         = { fg = solarized.violet },
        CmpItemKindValue             = { fg = solarized.violet },
        CmpItemKindConstructor       = { fg = solarized.blue },
        CmpItemKindStruct            = { fg = solarized.magenta },
        CmpItemKindEvent             = { fg = solarized.yellow },
        CmpItemKindEnum              = { fg = solarized.green },
        CmpItemKindUnit              = { fg = solarized.yellow },
        CmpItemKindModule            = { fg = solarized.green },
        CmpItemKindProperty          = { fg = solarized.yellow },
        CmpItemKindTypeParameter     = { fg = solarized.yellow },
        ...
        NavBuddyField                = { link = "CmpItemKindField" },
        NavBuddyClass                = { link = "CmpItemKindClass" },
        NavBuddyInterface            = { link = "CmpItemKindInterface" },
        NavBuddyVariable             = { link = "CmpItemKindVariable" },
        NavBuddyKeyword              = { link = "CmpItemKindKeyword" },
        NavBuddyConstant             = { link = "CmpItemKindConstant" },
        NavBuddyReference            = { link = "CmpItemKindReference" },
        NavBuddyValue                = { link = "CmpItemKindValue" },
        NavBuddyConstructor          = { link = "CmpItemKindConstructor" },
        NavBuddyStruct               = { link = "CmpItemKindStruct" },
        NavBuddyEvent                = { link = "CmpItemKindEvent" },
        NavBuddyEnum                 = { link = "CmpItemKindEnum" },
        NavBuddyUnit                 = { link = "CmpItemKindUnit" },
        NavBuddyModule               = { link = "CmpItemKindModule" },
        NavBuddyProperty             = { link = "CmpItemKindProperty" },
        NavBuddyTypeParameter        = { link = "CmpItemKindTypeParameter" },
