...
theme.loadPlugins = function()
    local plugins = {
        ...
        qfLineNr                     = { fg = solarized.magenta },
        qfSeparatorLeft              = { fg = solarized.magenta },
        qfSeparatorRight             = { fg = solarized.magenta },
        qfError                      = { fg = solarized.magenta },
        qfWarning                    = { fg = solarized.magenta },
        qfInfo                       = { fg = solarized.magenta },
        qfNote                       = { fg = solarized.magenta },
    }
