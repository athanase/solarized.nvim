...
theme.loadPlugins = function()
    local plugins = {
        ...
        -- CmpItemKindTypeParameter     = { fg = c.green1 },
        CmpItemKindEnumMember        = { solarized.cyan },
        CmpItemKindText              = { solarized.yellow },
        -- CmpItemKindOperator          = { fg = c.green1 },
        -- CmpItemKindSnippet           = { fg = c.dark5 },
        -- NavBuddy
        NavBuddyFunction             = { fg = solarized.blue },
        NavBuddyMethod               = { fg = solarized.blue },
        NavBuddyField                = { fg = solarized.cyan },
        NavBuddyClass                = { fg = solarized.magenta },
        NavBuddyInterface            = { fg = solarized.magenta },
        NavBuddyVariable             = { fg = solarized.cyan },
        NavBuddyKeyword              = { fg = solarized.orange },
        NavBuddyConstant             = { fg = solarized.orange },
        NavBuddyReference            = { fg = solarized.violet },
        NavBuddyValue                = { fg = solarized.violet },
        NavBuddyConstructor          = { fg = solarized.blue },
        NavBuddyStruct               = { fg = solarized.magenta },
        -- CmpItemKindEvent             = { fg = c.orange },
        NavBuddyEnum                 = { fg = solarized.green },
        -- CmpItemKindUnit              = { fg = c.orange },
        NavBuddyModule               = { fg = solarized.green },
        -- CmpItemKindProperty          = { fg = c.green1 },
        -- CmpItemKindTypeParameter     = { fg = c.green1 },
        NavBuddyEnumMember           = { solarized.cyan },
    }
